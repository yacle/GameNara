...
<form class="form-horizontal" action="/member/info" method="post">
	<div class="col-md-7">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
		    	<input type="text" class="form-control" id="nick" value="${map.NICKNAME }" placeholder="Enter NickName" name="nick"><span id="nickcheck"></span>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-9">
				...
				<c:choose>
					<c:when test="${empty map.EMAIL_REG }">
						<button type="button" id="emailReg"><small>인증메일보내기</small> </button><span id="codeInput"><input type="text" id="regCode" placeholder="Entet Code"></span>
					</c:when>
					<c:otherwise>
						인증완료
					</c:otherwise>
		...
		<div class="form-group">
			...
			<div class="col-sm-9">          
				<input type="text" class="form-control" id="phone" value="${map.PHONE_NUM }" placeholder="Enter Phone Number" name="phone">
			</div>
		</div>
		<div class="form-group">
...
<div class="form-group">        
	<div class="col-sm-offset-0 col-sm-12" align="center">
		<button type="button" class="btn btn-default" onclick="javascript:submit()">Submit</button>
	</div>
</div>
</form>
<script>
