...
<form action="/sell/add" method="post" enctype="multipart/form-data">
	<div class="row">
		...
		<div class="col-md-8">
			...
			<h4>판매가격 :</h4> <input type="text" class="form-control" name="price" id="price" placeholder="컴마(,)를 뺀 숫자만 입력해주세요 ex) 50000">
	...
	<div class="row" align="center">
		...
		<p><textarea style="width:900; height: 200" placeholder="상세내용" name="detail" id="detail"></textarea></p>
